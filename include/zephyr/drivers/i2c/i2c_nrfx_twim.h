...
typedef void (*i2c_nrfx_twim_async_transfer_handler_t)(const struct device *dev, int res, void *ctx);

int i2c_nrfx_twim_async_transfer_begin(const struct device *dev,
                                       struct i2c_msg *msg,
                                       uint16_t addr,
                                       i2c_nrfx_twim_async_transfer_handler_t handler,
                                       void *ctx);
